...
#define OMAP4430_VDD_MPU_OPP25_UV		890000
...
#define OMAP4430_VDD_MPU_OPPNITROOCA_UV		1388000
#define OMAP4430_VDD_MPU_OPPNITROOCB_UV		1398000


struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP25_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROOCA_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROOCA, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROOCB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROOCB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};

#define OMAP4430_VDD_IVA_OPP50_UV		 950000
#define OMAP4430_VDD_IVA_OPP100_UV		1114000
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1271000
...
#define OMAP4430_VDD_CORE_OPP150_UV     	1233000
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP150_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP150_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROOCA_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP150_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROOCB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP150_UV},
};
...
static struct omap_vdd_dep_volt omap443x_vdd_iva_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_IVA_OPPTURBO_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP150_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	/* MPU OPP0 - OPP25 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 196608000, OMAP4430_VDD_MPU_OPP25_UV),
	/* MPU OPP1 - OPP50 */
	...
	/* MPU OPP6 - OPP-OC-A */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1300000000, OMAP4430_VDD_MPU_OPPNITROOCA_UV),
	/* MPU OPP7 - OPP-OC-B */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1400000000, OMAP4430_VDD_MPU_OPPNITROOCB_UV),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", true, 133000000, OMAP4430_VDD_CORE_OPP50_UV),
	/* L3 OPP2 - OPP100, OPP-Turbo, OPP-SB */
	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", true, 233000000, OMAP4430_VDD_CORE_OPP100_UV),
	/* IVA OPP1 - OPP50 */
	...
	/* IVA OPP3 - OPP-Turbo */
	OPP_INITIALIZER("iva", "virt_iva_ck", "iva", true, 433000000, OMAP4430_VDD_IVA_OPPTURBO_UV),
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 153600000, OMAP4430_VDD_CORE_OPP50_UV),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 330700000, OMAP4430_VDD_CORE_OPP100_UV),
	/* SGX OPP3 - OPPOV */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 433000000, OMAP4430_VDD_CORE_OPP150_UV),
	/* FDIF OPP1 - OPP25 */
